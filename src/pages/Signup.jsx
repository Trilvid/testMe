...
import { BsEyeSlash, BsLink } from 'react-icons/bs'
...
const Signup = ({route}) => {
  ...
  <div className="input_container">
    <label htmlFor="name_field" className="input_label">Firstname</label>
  ...
  <div class="input_container">
    ...
    {/* try to remeber that the email type might be problematic change to type if there is a problem */}
    <input 
  ...
  <div class="input_container">
    <label class="input_label" for="confirm_field">Confirm</label>
    <section className='input_pass_container'>
    ...
    />
    <span onClick={()=>{setShowConfirmPassword(!showConfirmPassword)}} className='passIcon'>
                        {
                          showConfirmPassword ?
                          <BsEye />
                           :
...
<p class="note" onClick={()=>{ navigate('/login') }}> Sign in</p>
