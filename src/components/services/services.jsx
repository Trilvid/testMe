...
const Service = () => {
    ...
    const myServices = [
        ...
        },
        {
            id: 3,
            img: './invest.jpg',
            body: 'At OceanVolte we guide you through the dynamic Forex and cryptocurrency markets. Our expertise, research-driven approach, and commitment to risk management will help you navigate these markets with confidence and potentially achieve favorable returns. ',
